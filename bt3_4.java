...
public class bt3_4 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner lic_sc = new Scanner(new File("LICHGD.in"));
        ...
        int m = lic_sc.nextInt();
        ArrayList<lich> a = new ArrayList<>();
        for (int i = 1; i <= m; i++) {
            String code = lic_sc.next();
            int thu = lic_sc.nextInt();
            int kip = lic_sc.nextInt();
            lic_sc.nextLine();
            lich x = new lich(i, hmh.get(code), thu, kip, lic_sc.nextLine(),lic_sc.nextLine());
            a.add(x);
        }
        String gv = lic_sc.nextLine();
